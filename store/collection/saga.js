...
import { actionTypes, getCategoriesSuccess, getCollectionsSuccess, getGeolocationsSuccess } from './action';
...
function* getGeolocations() {
    try {
        const data = yield call(
            CollectionRepository.getGeolocations,
            null
        );
        yield put(getGeolocationsSuccess(data));
    } catch (err) {
        console.log(err);
    }
}
...
export default function* rootSaga() {
    yield all([takeEvery(actionTypes.GET_GEOLOCATIONS, getGeolocations)]);
