export const actionTypes = {
    ...
    GET_GEOLOCATIONS: 'GET_GEOLOCATIONS',
    GET_GEOLOCATIONS_SUCCESS: 'GET_GEOLOCATIONS_SUCCESS',
};

export function getGeolocations() {
    return { type: actionTypes.GET_GEOLOCATIONS };
}

export function getGeolocationsSuccess(payload) {
    return {
        type: actionTypes.GET_GEOLOCATIONS_SUCCESS,
        payload,
    };
}
